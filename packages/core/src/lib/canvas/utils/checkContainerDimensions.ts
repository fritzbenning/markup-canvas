/**
 * Warns on the console when the container has zero width or height with `auto` sizing, which usually breaks layout.
 *
 * @param container - Canvas root element to inspect.
 */
